-- PostgreSQL Schema for VA Signals (Unified)
...
CREATE TABLE IF NOT EXISTS evidence_excerpts (
    excerpt_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    source_id TEXT NOT NULL,
...
INSERT INTO tenants (tenant_id, name, slug, plan, status, created_at, updated_at, owner_user_id)
VALUES ('tenant_default', 'VetClaims.ai', 'default', 'enterprise', 'active', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'pending-commander')
ON CONFLICT (tenant_id) DO NOTHING;

INSERT INTO tenant_settings (tenant_id, api_rate_limit_per_minute, api_rate_limit_per_day, max_users, max_signals_per_day, enable_ml_scoring, enable_custom_integrations, data_retention_days, created_at, updated_at)
VALUES ('tenant_default', 500, 100000, 999, 50000, TRUE, TRUE, 730, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (tenant_id) DO NOTHING;

INSERT INTO tenant_members (user_id, tenant_id, role, joined_at, is_primary)
VALUES ('pending-commander', 'tenant_default', 'commander', CURRENT_TIMESTAMP, TRUE)
